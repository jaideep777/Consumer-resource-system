...
for (ib in 1:length(bvec)){
  ...
  # h
  if (expt == "hom"){
    fname = sprintf("%s/%s/hist_h_%s_T(%.3g)_N(%g)_RT(%g)_kd(%g)_h(%g)_rI(%.3g)_kI(%.3g)_L(%g)_nx(%g)_b(%.3g)_cd(%g)_ch(%.3g)_muh(%.3g)_murt(%.3g)_mukd(%.3g)_twv(%.3g)",
                    homdir,outdir,  expt, nsteps/1000,  N, RT, kd, h,     rI,   kI, L,      nx,   b,    cd,    ch  , muh, murt, mukd, tw)
  } else{
  ...
  image(x = times, y= c(brks_h[1:nbins],brks_h[nbins]+0.01), log(hall+1), col = cols, xlab="time", main=paste("ri=", rI))
  ...
  # kd
  if (expt == "hom"){
    fname = sprintf("%s/%s/hist_kd_%s_T(%.3g)_N(%g)_RT(%g)_kd(%g)_h(%g)_rI(%.3g)_kI(%.3g)_L(%g)_nx(%g)_b(%.3g)_cd(%g)_ch(%.3g)_muh(%.3g)_murt(%.3g)_mukd(%.3g)_twv(%.3g)",
                    homdir,outdir,  expt, nsteps/1000,  N, RT, kd, h,     rI,   kI, L,      nx,   b,    cd,    ch  , muh, murt, mukd, tw)
  } else{
  ...
  image(x = times, y= c(brks_kd[1:nbins],brks_kd[nbins]+0.01), log(hall+1), col = cols, xlab="time", main=paste("ri=", rI))
  
  # rc
  if (expt == "hom"){
    fname = sprintf("%s/%s/hist_rc_%s_T(%.3g)_N(%g)_RT(%g)_kd(%g)_h(%g)_rI(%.3g)_kI(%.3g)_L(%g)_nx(%g)_b(%.3g)_cd(%g)_ch(%.3g)_muh(%.3g)_murt(%.3g)_mukd(%.3g)_twv(%.3g)",
                    homdir,outdir,  expt, nsteps/1000,  N, RT, kd, h,     rI,   kI, L,      nx,   b,    cd,    ch  , muh, murt, mukd, tw)
  } else{
  ...
  # rtotal
  if (expt == "hom"){
    fname = sprintf("%s/%s/r_total_%s_T(%.3g)_N(%g)_RT(%g)_kd(%g)_h(%g)_rI(%.3g)_kI(%.3g)_L(%g)_nx(%g)_b(%.3g)_cd(%g)_ch(%.3g)_muh(%.3g)_murt(%.3g)_mukd(%.3g)_twv(%.3g)",
                    homdir,outdir,  expt, nsteps/1000,  N, RT, kd, h,     rI,   kI, L,      nx,   b,    cd,    ch  , muh, murt, mukd, tw)
  } else{
...
#  png(filename=sprintf("/home/jaideep/austria_project/gpu_codes/figures/imit_rate_ts_long/imit_%.4f.png", bvec[ib]))
   image(x = times, y= c(brks_h[1:nbins],brks_h[nbins]+0.01), log(hall+1), col = cols, xlab="time")
#  dev.off()
}
